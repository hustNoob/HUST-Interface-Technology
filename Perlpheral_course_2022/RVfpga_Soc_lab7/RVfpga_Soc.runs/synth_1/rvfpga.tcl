...
set_property webtalk.parent_dir C:/workspace/Perlpheral_course_2022/RVfpga_Soc_lab7/RVfpga_Soc.cache/wt [current_project]
set_property parent.project_path C:/workspace/Perlpheral_course_2022/RVfpga_Soc_lab7/RVfpga_Soc.xpr [current_project]
...
update_ip_catalog
set_property ip_output_repo c:/workspace/Perlpheral_course_2022/RVfpga_Soc_lab7/RVfpga_Soc.cache/ip [current_project]
...
read_verilog -library xil_defaultlib {
  ...
  C:/workspace/Perlpheral_course_2022/RVfpga_Soc_lab7/RVfpga_Soc.srcs/sources_1/bd/swerv_soc/hdl/swerv_soc_wrapper.v
}
add_files C:/workspace/Perlpheral_course_2022/RVfpga_Soc_lab7/RVfpga_Soc.srcs/sources_1/bd/swerv_soc/swerv_soc.bd
set_property used_in_implementation false [get_files -all c:/workspace/Perlpheral_course_2022/RVfpga_Soc_lab7/RVfpga_Soc.srcs/sources_1/bd/swerv_soc/ip/swerv_soc_axi_gpio_0_0/swerv_soc_axi_gpio_0_0_board.xdc]
set_property used_in_implementation false [get_files -all c:/workspace/Perlpheral_course_2022/RVfpga_Soc_lab7/RVfpga_Soc.srcs/sources_1/bd/swerv_soc/ip/swerv_soc_axi_gpio_0_0/swerv_soc_axi_gpio_0_0_ooc.xdc]
set_property used_in_implementation false [get_files -all c:/workspace/Perlpheral_course_2022/RVfpga_Soc_lab7/RVfpga_Soc.srcs/sources_1/bd/swerv_soc/ip/swerv_soc_axi_gpio_0_0/swerv_soc_axi_gpio_0_0.xdc]
set_property used_in_implementation false [get_files -all c:/workspace/Perlpheral_course_2022/RVfpga_Soc_lab7/RVfpga_Soc.srcs/sources_1/bd/swerv_soc/ip/swerv_soc_xbar_0/swerv_soc_xbar_0_ooc.xdc]
set_property used_in_synthesis false [get_files -all c:/workspace/Perlpheral_course_2022/RVfpga_Soc_lab7/RVfpga_Soc.srcs/sources_1/bd/swerv_soc/ip/swerv_soc_auto_ds_0/swerv_soc_auto_ds_0_clocks.xdc]
set_property used_in_implementation false [get_files -all c:/workspace/Perlpheral_course_2022/RVfpga_Soc_lab7/RVfpga_Soc.srcs/sources_1/bd/swerv_soc/ip/swerv_soc_auto_ds_0/swerv_soc_auto_ds_0_clocks.xdc]
set_property used_in_implementation false [get_files -all c:/workspace/Perlpheral_course_2022/RVfpga_Soc_lab7/RVfpga_Soc.srcs/sources_1/bd/swerv_soc/ip/swerv_soc_auto_ds_0/swerv_soc_auto_ds_0_ooc.xdc]
set_property used_in_implementation false [get_files -all c:/workspace/Perlpheral_course_2022/RVfpga_Soc_lab7/RVfpga_Soc.srcs/sources_1/bd/swerv_soc/ip/swerv_soc_auto_pc_0/swerv_soc_auto_pc_0_ooc.xdc]
set_property used_in_implementation false [get_files -all C:/workspace/Perlpheral_course_2022/RVfpga_Soc_lab7/RVfpga_Soc.srcs/sources_1/bd/swerv_soc/swerv_soc_ooc.xdc]
