...
# module references:
# bootrom_wrapper, ptc_wrapper, syscon_wrapper, wb_uart_wrapper
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_0_1 [get_bd_ports clk_0] [get_bd_pins PWM_w_Int_0/s00_axi_aclk] [get_bd_pins axi2wb_intcon_wrapper_0/clk_i_wrapper] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins bootrom_wrapper_0/i_clk] [get_bd_pins ptc_wrapper_0/wb_clk_i] [get_bd_pins swerv_wrapper_verilog_0/clk] [get_bd_pins syscon_wrapper_0/i_clk] [get_bd_pins wb_gpio_wrapper_0/wb_clk_i] [get_bd_pins wb_uart_wrapper_0/wb_clk_i]
  ...
  connect_bd_net -net rst_0_1 [get_bd_ports rst_0] [get_bd_pins PWM_w_Int_0/s00_axi_aresetn] [get_bd_pins axi2wb_intcon_wrapper_0/rst_ni_wrapper] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins bootrom_wrapper_0/i_rst] [get_bd_pins ptc_wrapper_0/wb_rst_i] [get_bd_pins swerv_wrapper_verilog_0/rst] [get_bd_pins syscon_wrapper_0/i_rst] [get_bd_pins wb_gpio_wrapper_0/wb_rst_i] [get_bd_pins wb_uart_wrapper_0/wb_rst_i]
