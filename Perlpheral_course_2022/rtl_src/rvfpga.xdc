...
set_property -dict { PACKAGE_PIN R11   IOSTANDARD LVCMOS33 } [get_ports { pwm_pad_o }];
...
#Audio
set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { Audio }]; 
set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { Audio_enable }];