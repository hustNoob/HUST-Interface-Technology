...
set rc [catch {
  ...
  add_files -quiet C:/workspace/Perlpheral_course_2022/RVfpga_Soc_lab6/RVfpga_Soc.runs/synth_1/rvfpga.dcp
...
set rc [catch {
  ...
  set src_rc [catch { 
    puts "source C:/workspace/Perlpheral_course_2022/script.tcl"
    source C:/workspace/Perlpheral_course_2022/script.tcl
  } _RESULT] 
  if {$src_rc} { 
    send_msg_id runtcl-1 error "$_RESULT"
    send_msg_id runtcl-2 error "sourcing script C:/workspace/Perlpheral_course_2022/script.tcl failed"
    return -code error
  }
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
