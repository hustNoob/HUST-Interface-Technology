...
proc create_root_design { parentCell } {
  ...
  set Audio [ create_bd_port -dir O Audio ]
  set Audio_enable [ create_bd_port -dir O Audio_enable ]
  ...
  set pwm_pad_o [ create_bd_port -dir O pwm_pad_o ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M03_AXI [get_bd_intf_pins Audio_0/S00_AXI] [get_bd_intf_pins axi_interconnect_0/M03_AXI]
  ...
  connect_bd_net -net Audio_0_Audio [get_bd_ports Audio] [get_bd_pins Audio_0/Audio]
  connect_bd_net -net Audio_0_Audio_enable [get_bd_ports Audio_enable] [get_bd_pins Audio_0/Audio_enable]
  connect_bd_net -net PWM_w_Int_0_Interruput_out [get_bd_pins PWM_w_Int_0/Interruput_out] [get_bd_pins xlconcat_0/In1]
  ...
  connect_bd_net -net clk_0_1 [get_bd_ports clk_0] [get_bd_pins Audio_0/s00_axi_aclk] [get_bd_pins PWM_w_Int_0/s00_axi_aclk] [get_bd_pins axi2wb_intcon_wrapper_0/clk_i_wrapper] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins bootrom_wrapper_0/i_clk] [get_bd_pins ptc_wrapper_0/wb_clk_i] [get_bd_pins swerv_wrapper_verilog_0/clk] [get_bd_pins syscon_wrapper_0/i_clk] [get_bd_pins wb_gpio_wrapper_0/wb_clk_i] [get_bd_pins wb_spi_wrapper_0/wb_clk_i] [get_bd_pins wb_uart_wrapper_0/wb_clk_i]
  ...
  connect_bd_net -net ptc_wrapper_0_pwm_pad_o [get_bd_ports pwm_pad_o] [get_bd_pins ptc_wrapper_0/pwm_pad_o]
  ...
  assign_bd_address -offset 0x80140000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi2wb_intcon_wrapper_0/o_user_axi4] [get_bd_addr_segs Audio_0/S00_AXI/S00_AXI_reg] -force
