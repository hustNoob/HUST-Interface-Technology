...
int main(void)
{
    int data = 0, data_2; //data接收温度，然后data整数部分，data_2小数部分，temp_set阈值
    float temp = 0, temp_set;
    ...
    temp_set = temp_set * 10 + uart_inbyte() - 0x30;//输入两位数字
